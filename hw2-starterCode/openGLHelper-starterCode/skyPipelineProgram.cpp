...
int SkyPipelineProgram::Init(const char * shaderBasePath,const char * filename1,const char * filename2) 
{
...
void SkyPipelineProgram::SetModelViewMatrix(const float * m) 
{
...
void SkyPipelineProgram::SetProjectionMatrix(const float * m) 
{
...
int SkyPipelineProgram::SetShaderVariableHandles() 
{
