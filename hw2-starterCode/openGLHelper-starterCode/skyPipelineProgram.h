...
class SkyPipelineProgram : public PipelineProgram
{
public:
  int Init(const char * shaderBasePath,const char * filename1,const char * filename2) ; // init the program, "shaderBasePath" is the path to the folder containing the shaders
